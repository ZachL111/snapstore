...
`snapstore` is centered on storage work in Java. The technical target is: Simulate snapshotting key-value storage with WAL replay and compaction.
...
The score is deterministic. The current threshold is 167. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 2.
