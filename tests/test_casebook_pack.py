"""Regression checks for the snapstore casebook."""
...
from casebook.harness import assert_expected, snapstore_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(snapstore_summary(), assert_expected())
